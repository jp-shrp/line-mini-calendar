...
import { ItemEdit422Client } from './components/ItemEdit422Client'

export default async function ItemEdit422Page({
    params,
}: {
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600">
                    編集フォーム表示用データ取得時の422バリデーションエラーテスト（CSR）
                </p>
            </div>
            ...
            <div className="mb-8 rounded-lg bg-blue-50 p-4">
                ...
                <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Link
                        ...
                        className="rounded bg-orange-100 px-3 py-2 text-sm text-orange-700 hover:bg-orange-200">
                        ❌ 編集データ取得422エラー（現在のページ）
                    </Link>
                    <Link
            ...
            <ItemEdit422Client id={id.toString()} />
        </div>
    )
}
