...
import { ItemEdit500Client } from './components/ItemEdit500Client'

export default async function ItemEdit500Page({
    params,
}: {
            ...
            <div className="mb-8 rounded-lg bg-blue-50 p-4">
                ...
                <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Link
                        ...
                        className="rounded bg-red-100 px-3 py-2 text-sm text-red-700 hover:bg-red-200">
                        ❌ 編集データ取得500エラー（現在のページ）
                    </Link>
                </div>
            </div>

            <ItemEdit500Client id={id.toString()} />
        </div>
    )
}
