...
import { MoreError400Client } from './components/MoreError400Client'
import Link from 'next/link'

export default async function MoreError400Page() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <MoreError400Client initialItems={initialItems} />
        </div>
    )
}
