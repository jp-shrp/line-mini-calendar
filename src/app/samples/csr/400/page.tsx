...
/**
 * 400エラーテストページ
 * Client Component + React Queryで400エラーレスポンスを確認する例
 */
...
export default function CSR400ErrorPage() {
    ...
    const handleDirectCall = async () => {
        ...
        try {
            ...
            console.error('400 Error caught:', err)
            setErrorDetails({
                title:
    ...
    return (
        <div className="container mx-auto p-8">
            <h1 className="mb-6 text-3xl font-bold">400 Error Test Page</h1>

            <div className="mb-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                <h2 className="mb-2 text-lg font-semibold">⚠️ テスト目的</h2>
                <p className="mb-3 text-sm text-gray-700">
                    このページは400エラー (Bad Request)
                    が発生した際のエラーハンドリングを確認するためのテストページです。
                </p>
                <p className="text-sm text-gray-700">
                    実際にEdge
                    Functionから400エラーが返却された際に、どのようにエラーが表示されるかを確認できます。
                </p>
            </div>
            ...
            <div className="mb-6 rounded-lg border border-gray-200 bg-white p-6">
                <h2 className="mb-4 text-xl font-semibold">
                    1. useSupabaseQuery による400エラー
                </h2>
                <p className="mb-4 text-sm text-gray-600">
                    React Queryのフックを使用して400エラーを発生させます。
                </p>
            ...
            <div className="mb-6 rounded-lg border border-gray-200 bg-white p-6">
                <h2 className="mb-4 text-xl font-semibold">
                    2. callEdgeFunction による400エラー
                </h2>
                <p className="mb-4 text-sm text-gray-600">
                    callEdgeFunctionを直接使用して400エラーを発生させます。
                </p>

                <button
                    onClick={handleDirectCall}
                    className="mb-4 rounded bg-orange-600 px-4 py-2 text-white hover:bg-orange-700">
                    400エラーを直接呼び出し
                </button>
